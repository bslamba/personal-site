  ...
  domains: [
    ...
    },
    {
      ...
      topics: [
        ...
        { n: '4.4', title: 'Explain the function of SNMP in network operations', tags: ['SNMP', 'MIB', 'trap', 'OID'] },
    ...
    },
    {
      ...
      topics: [
        ...
        { n: '3.3', title: 'IP Services',
          ...
          lab: 'Build HSRP with preemption and interface tracking, then fail the tracked uplink.' },
      ],
    },
    {
  ...
  domains: [
    {
      ...
      topics: [
        ...
        { n: '1.4', title: 'Troubleshoot redistribution between any routing protocols or routing sources',
          ...
          lab: 'Mutually redistribute OSPF and EIGRP at two points and fix the suboptimal paths.' },
        ...
        { n: '1.6', title: 'Configure and verify policy-based routing',
          tags: ['PBR', 'route-map', 'set ip next-hop', 'policy routing'],
        ...
        { n: '1.7', title: 'Configure and verify VRF-Lite',
          tags: ['VRF', 'VRF-lite', 'route distinguisher', 'address family'],
