  ...
  domains: [
    {
      ...
      topics: [
        { n: '1.1', title: 'Explain the role and function of network components',
          slug: 'network-components-topologies-cabling-and-interface-errors',
        ...
        { n: '1.6', title: 'Configure and verify IPv4 addressing and subnetting',
          slug: 'ipv4-addressing-subnetting-and-verifying-a-client',
        ...
        { n: '1.7', title: 'Describe private IPv4 addressing', slug: 'ipv4-addressing-subnetting-and-verifying-a-client',
          tags: ['RFC 1918', 'NAT', 'private address'] },
        ...
        { n: '1.11', title: 'Describe wireless principles',
          slug: 'wireless-principles-rf-channels-and-ap-modes',
        ...
        { n: '1.12', title: 'Explain virtualization fundamentals (server virtualization, containers, and VRFs)',
          slug: 'virtualization-vms-containers-and-network-virtualization',
    ...
    },
    {
      ...
      topics: [
        ...
        { n: '2.8', title: 'Describe network device management access (Telnet, SSH, HTTP, HTTPS, console, TACACS+/RADIUS, and cloud managed)',
          slug: 'aaa-radius-tacacs-explained',
        ...
        { n: '2.9', title: 'Interpret the wireless LAN GUI configuration for client connectivity, such as WLAN creation, security settings, QoS profiles, and advanced settings',
          slug: 'wlan-security-wpa2-wpa3-and-the-four-way-handshake',
    ...
    },
    {
      ...
      topics: [
        ...
        { n: '3.3', title: 'Configure and verify IPv4 and IPv6 static routing',
          slug: 'static-routes-dhcp-relay-and-file-transfer',
    ...
    },
    {
      ...
      topics: [
        ...
        { n: '4.7', title: 'Explain the forwarding per-hop behavior (PHB) for QoS such as classification, marking, queuing, congestion, policing, and shaping',
          slug: 'qos-classification-marking-queuing-and-phb',
    ...
    },
    {
      ...
      topics: [
        { n: '5.1', title: 'Define key security concepts (threats, vulnerabilities, exploits, and mitigation techniques)',
          slug: 'security-fundamentals-threats-policy-and-network-design',
    ...
    },
    {
      ...
      topics: [
        { n: '6.1', title: 'Explain how automation impacts network management',
          slug: 'network-automation-orchestration-and-eem', tags: ['automation', 'CLI', 'drift'] },
        { n: '6.2', title: 'Compare traditional networks with controller-based networking',
          slug: 'sdn-controllers-overlays-sd-access-and-sd-wan',
        ...
        { n: '6.4', title: 'Explain AI (generative and predictive) and machine learning in network operations',
          slug: 'ai-and-ml-in-network-operations',
        ...
        { n: '6.6', title: 'Recognize the capabilities of configuration management mechanisms such as Ansible and Terraform',
          slug: 'network-automation-orchestration-and-eem',
          tags: ['Ansible', 'Terraform', 'idempotent', 'declarative'] },
        { n: '6.7', title: 'Recognize components of JSON-encoded data', slug: 'json-yaml-and-python-for-network-engineers', tags: ['JSON', 'key value', 'array', 'object'] },
      ],
    },
  ],
}
...
const ENCOR: Exam = {
  ...
  domains: [
    ...
    },
    {
      ...
      topics: [
        { n: '4.1', title: 'Diagnose network problems using such as debugs, conditional debugs, traceroute, ping, SNMP, and syslog',
          slug: 'network-troubleshooting-tools-ping-traceroute-debug',
    ...
    },
    {
      ...
      topics: [
        ...
        { n: '5.2', title: 'Configure and verify infrastructure security features',
          slug: 'infrastructure-security-copp-acls-and-ipv6-first-hop',
          subs: ['ACLs', 'CoPP'],
        ...
        { n: '5.3', title: 'Describe REST API security', slug: 'netconf-restconf-yang-and-rest-apis', tags: ['REST', 'API security', 'token', 'OAuth', 'TLS'] },
    ...
    },
    {
      ...
      topics: [
        { n: '6.1', title: 'Interpret basic Python components and scripts', slug: 'json-yaml-and-python-for-network-engineers', tags: ['Python', 'script', 'loop', 'function'] },
        { n: '6.2', title: 'Construct valid JSON-encoded files', slug: 'json-yaml-and-python-for-network-engineers', tags: ['JSON', 'encoding', 'validation'] },
  ...
  domains: [
    {
      ...
      topics: [
        ...
        { n: '1.2', title: 'Troubleshoot route map for any routing protocol (attributes, tagging, filtering)',
          slug: 'route-maps-loop-prevention-and-summarisation',
        ...
        { n: '1.8', title: 'Describe Bidirectional Forwarding Detection',
          slug: 'bidirectional-forwarding-detection-bfd',
    ...
    },
    {
      ...
      topics: [
        { n: '2.1', title: 'Describe MPLS operations (LSR, LDP, label switching, LSP)',
          slug: 'mpls-lsr-ldp-label-switching-and-l3vpn',
        ...
        { n: '2.3', title: 'Configure and verify DMVPN (single hub)',
          slug: 'dmvpn-nhrp-mgre-and-spoke-to-spoke-tunnels',
    ...
    },
    {
      ...
      topics: [
        { n: '4.1', title: 'Troubleshoot device management',
          slug: 'troubleshooting-device-management',
